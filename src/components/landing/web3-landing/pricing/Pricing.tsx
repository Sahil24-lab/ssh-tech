  ...
  const pricingPlans = [
    {
      ...
      features: [
        ...
        "Production-ready front-end with resilient fallback handling",
    ...
    },
    {
      ...
      features: [
        ...
        "Secure API & Subgraph integration with fallback logic",
        "Sentry integration for wallet and transaction failure monitoring",
        "Real-time analytics dashboards for usage, transactions, and Users",
        "Frontend security review (CSP, XSS protection)",
        "Lightweight monitoring and weekly issue summaries",
    ...
    },
    {
      ...
      features: [
        ...
        "24/7 private Discord access (best-effort response under 2h for blockers)",
        "LogRocket integration for session replay & debugging",
        "Monthly Deep technical audits (UI, infra, tx failure patterns)",
        "Transaction error visibility & failure type reporting",
